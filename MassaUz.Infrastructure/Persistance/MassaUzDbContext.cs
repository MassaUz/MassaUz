...
namespace MassaUz.Infrastructure.Persistance
{
    public class MassaUzDbContext : IdentityDbContext<User, IdentityRole<Guid>, Guid>, IMassaUzDbContext
    {
        public MassaUzDbContext(DbContextOptions<MassaUzDbContext> options)
            : base(options)
        {
            Database.Migrate();
        }
